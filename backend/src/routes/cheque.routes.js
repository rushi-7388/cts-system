...
router.post("/bulk-ingest", authorize("PRESENTING_BANK", "BRANCH_MANAGER", "ADMIN"), bulkIngestCheques);
router.post("/", authorize("PRESENTING_BANK", "BRANCH_MANAGER", "ADMIN"), upload.single("chequeImage"), createCheque);
